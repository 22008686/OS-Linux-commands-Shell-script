...
OUTPUT
303979828-3d17b2b3-39c8-43a8-abdc-519c900acba8

comm file1 file2

OUTPUT
303980017-9f15abc6-fa53-4ce6-9690-41d0c5527c64

diff file1 file2

##OUTPUT 303980022-6f0df5d6-6dc0-473f-8764-8f8788dc1423
...
OUTPUT
303980526-e74cc399-e869-4514-9294-e4d66bdbb553

cut -d "|" -f 1 file22

OUTPUT
303980625-45a81470-3b96-4c0b-9c34-21ef65d280c1

cut -d "|" -f 2 file22

OUTPUT
303980718-81235175-e464-4178-a1da-d78a36605b9b
...
OUTPUT
304111559-7d5dc360-1c3a-4ec4-9367-a9d3ebf3da9d

grep hello newfile

OUTPUT
304111717-3b622860-62e3-4eba-88ad-9644765927df
...
OUTPUT
304112674-10be401c-081e-4138-af1f-88aa41158c77

cat newfile | grep -i -c "hello"

OUTPUT
304113192-a2eb2603-767e-486a-bb38-c9e1f53f51a3
...
OUTPUT
304114184-cb370c18-be74-432d-9314-51f331acf7df
...
OUTPUT
304114664-f2413676-3063-4310-9007-e31987305c59

egrep -w '(H|h)ell[a-z]' newfile

OUTPUT
304116131-7a74a2cf-5316-47fc-8448-8cae00930409

egrep '(^hello)' newfile

OUTPUT
304751858-2097ab41-753f-4c27-bf30-f3c2b3edd826

egrep '(world$)' newfile

OUTPUT
304752068-d6105214-5e17-4bcf-82c9-256ac369f797

egrep '(World$)' newfile

OUTPUT
304752280-d3019e06-e463-45ab-bf66-985f54a7edb9

egrep '((W|w)orld$)' newfile

OUTPUT
304752550-c0c28d29-8373-4c75-b10a-e3a1ee97271a

egrep '[1-9]' newfile

OUTPUT
304752743-d525b4d0-ceaf-456e-b23e-98fc98180629

egrep 'Linux.*world' newfile

OUTPUT
304753008-b3b81c41-51b4-406b-b712-21a2a4c9d97c

egrep 'Linux.*World' newfile

OUTPUT
304753573-6bb38c3a-f787-4522-9190-8a797f9ec430

egrep l{2} newfile

OUTPUT
304754057-82fd9878-0b30-4a54-8ab5-18dd15381f65

egrep 's{1,2}' newfile

OUTPUT
304754458-c92a0337-816f-4d2f-a34d-6748b3cb1bee
...
OUTPUT
304757591-a648b63d-4908-491b-83e2-15d2a6549860
...
OUTPUT
304758431-084144ca-9506-4676-8b2a-4ce86686c9e6
...
OUTPUT
304759583-b67f110e-2c70-4583-a1be-a37ad91ad49d

sed -n -e '1,5p' file23

OUTPUT
304759738-4539c59e-1967-4511-aa85-02e0193a1e13

sed -n -e '2,/Joe/p' file23

OUTPUT
304759889-30234a9f-dd11-4ae5-b7a5-9045148072a0

sed -n -e '/tom/,/Joe/p' file23

OUTPUT
304766794-9a68ec8b-c637-4d4f-b099-279531805f0b

seq 10

OUTPUT
304767015-a6426c76-366f-4acd-9a74-05d4c22cd1ef

seq 10 | sed -n '4,6p'

OUTPUT
304767368-be70bf5e-1699-41fc-aa85-bdcde8e946ca

seq 10 | sed -n '2,~4p'

OUTPUT
304767623-4dae8842-394b-4660-98d8-f1ff6de58121

seq 3 | sed '2a hello'

OUTPUT
304768147-98a1731b-3015-45f1-ba23-6cb031f09c8d
...
OUTPUT
304768441-9c4330d4-0447-451d-a81a-cf358636d16d

sed -n '2,4{s/^/$/;p}' file23

OUTPUT
304768689-da40ce9b-3d87-4252-90db-988a1f344a81
...
OUTPUT
304771138-0b50c2dc-0ef6-4965-92c6-5b0ff5735bd1
...
OUTPUT
304771761-734761d9-86e9-4b02-9948-1a8de5e92c36
...
OUTPUT
304797034-9a10a40c-28d3-4c0d-929f-609b1615fb79

cat urllist.txt | tr -d ' ' | tr -s '.'

OUTPUT
304797372-2499ab97-1897-440e-b6b7-2d2f3a95a31a

#Backup commands tar -cvf backup.tar *

OUTPUT
304797792-7f1581bd-5f95-4e4e-866f-1699b6f40de5
